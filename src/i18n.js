    ...
    en: {
        translation: {
            ...
            chat: {
                ...
                voiceProcessing: 'Your assistant is thinking…',
                voiceSpeaking: 'Speaking…',
                voiceLiveHint: 'Live voice · answers use your chatbot',
                files: '{{count}} File(s)',
    ...
    hi: {
        translation: {
            ...
            chat: {
                ...
                voiceProcessing: 'आपका सहायक सोच रहा है…',
                voiceSpeaking: 'बोल रहा है…',
                voiceLiveHint: 'लाइव आवाज़ · उत्तर आपके चैटबॉट से',
                files: '{{count}} फाइल(ें)',
