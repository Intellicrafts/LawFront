      ...
      steps: [
        {
          ...
          popover: {
            ...
            description: '<div class="tour-description-compact"><strong>Your trusted AI legal companion</strong><br/>Get instant answers to legal questions, draft documents professionally, and receive expert guidance on Indian law—all in one intelligent platform.</div>',
            side: 'bottom',
            align: 'center'
          }
        },
        {
          ...
          popover: {
            ...
            description: '<div class="tour-description-compact">Type your legal question here. Share relevant details like case names, dates, or jurisdiction to get more tailored answers.</div>',
            side: 'top',
            align: 'center'
          }
        },
        {
          ...
          popover: {
            ...
            description: '<div class="tour-description-compact">No time to type? Just click the microphone to speak your legal question naturally. We\'ll transcribe and answer instantly.</div>',
            side: 'top',
            align: 'center'
          }
        },
        {
          ...
          popover: {
            ...
            description: '<div class="tour-description-compact">All your legal conversations are safely stored here. Search, manage, and revisit your previous consultations anytime—completely private and encrypted.</div>',
            side: 'right',
            align: 'center'
          }
        },
        ...
        },
        {
          ...
          popover: {
            ...
            description: '<div class="tour-description-compact"><strong>Ready to get legal help?</strong><br/>Start by asking anything related to Indian law—contracts, property, corporate matters, or general legal advice. Our AI is here to help 24/7.</div>',
            side: 'center',
            align: 'center'
          }
        }
