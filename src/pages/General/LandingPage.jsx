...
const LandingPage = () => {
    ...
    return (
        <div className={`w-full min-h-screen overflow-x-hidden transition-colors duration-500 ${isDark
            ? 'bg-[#0A0A0A]'
            : 'bg-white'
            }`}
        >
            {/* Zoomed-out wrapper for premium feel */}
            <div className="scale-[0.92] origin-top">
              ...
              ═══════════════════════════════════════════ */}
                <motion.section
                    ...
                    className={`relative pt-32 md:pt-40 pb-20 md:pb-28 px-4 md:px-6 min-h-[88vh] flex items-center ${isDark
